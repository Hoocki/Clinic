var dbProperties = {
    database: 'hospital_timetable', // название базы данных
...
db.journal = require('../model/journal.model.js')(sequelize, Sequelize);
db.doctor = require('../model/doctor.model.js')(sequelize, Sequelize);
db.specialization = require('../model/specialization.model.js')(sequelize, Sequelize);
